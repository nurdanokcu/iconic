...
<template>
  ...
  >
    <HomeHeaderImages
      class="px-8 pb-4 md:order-1 md:px-12 md:h-[44%] md:pb-6 lg:h-auto lg:col-span-3 lg:row-span-7 lg:order-0 lg:pl-6 lg:pr-2 xl:px-16"
    />
    <HomeHeaderMenu
      class="px-8 items-end mb-4 md:order-0 md:flex-1 md:px-12 md:h-[30%] lg:h-auto lg:col-span-2 lg:row-span-7 lg:order-1 lg:pl-2 lg:pr-6 xl:px-16"
    />
    <HomeHeaderBottom
