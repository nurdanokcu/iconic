...
<template>
  <div>
    <HomeHeader
      ref="header"
      class="header w-full h-screen min-h-[720px] md:min-h-[820px] lg:min-h-[640px] max-w-page-width-xl mx-auto sticky top-0"
    />
    <main class="relative bg-white z-50">
      ...
      <HomeBlogPosts class="centered-container lg:px-20" />
